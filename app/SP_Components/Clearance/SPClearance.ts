...
import ClearanceService from "../../interface-models/sp_type_services/Clearance";
...
@Component({
  selector: 'app-sp-clearance',
  templateUrl: './SPClearance.html',
  styleUrls: ['./SPClearance.css']
})

export class SPClearance {
  title = "Clearance";
  getParam: any;
  account_id: any = "";
  getRFQParamID: any;
  ...
  formGroup: any = new FormGroup({
    Clearance_Time_days: new FormControl<Date>(new Date()),
  ...
  createQuotation(SPQuote: ClearanceService) {
