...
@Component({
  selector: 'app-sp-equipment',
  templateUrl: './SPEquipment.html',
  styleUrls: ['./SPEquipment.css']
})

export class SPEquipment {
  ...
  formGroup: any = new FormGroup({
    Rental_Time_hours: new FormControl<Date>(new Date()),
  ...
  createQuotation(SPQuote: EquipmentService) {
