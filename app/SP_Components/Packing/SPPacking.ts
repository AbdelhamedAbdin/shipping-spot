...
import StorageService from "../../interface-models/sp_type_services/Packing";
...
@Component({
  selector: 'app-sp-packing',
  templateUrl: './SPPacking.html',
  styleUrls: ['./SPPacking.css']
})

export class SPPacking {
  title = "Packing";
  getParam: any;
  account_id: any = "";
  getRFQParamID: any;
  ...
  formGroup: any = new FormGroup({
    Packing_Time_days: new FormControl<Date>(new Date()),
